...
@Component({
  selector: 'app-todo-interaction',
  templateUrl: './todo-interaction.component.html',
  styleUrls: ['./todo-interaction.component.scss'],
})
export class TodoInteractionComponent {
